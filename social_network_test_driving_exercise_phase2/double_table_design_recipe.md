...
network,user,information,account,email_address,
username, timeline, posts, title, content,
views
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| users                 | username, account, email_address
| posts                 | title, content, views

1. Name of the first table (always plural): `users` 

    Column names: `username`, `account`, `email_address`
...
```bash
psql -h 127.0.0.1 social_network < albums_table.sql
```
